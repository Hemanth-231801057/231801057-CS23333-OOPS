...
public class ChemistChangePassword extends JFrame implements ActionListener{
	...
	l2=new JLabel("New Password");
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/img8.png"));
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==b1){
            ...
            String str1 = "update credential set password = '"+newpass+"' where designation = 'Chemist'";
            try{
