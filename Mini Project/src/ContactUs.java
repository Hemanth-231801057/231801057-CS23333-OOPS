...
public class ContactUs extends JFrame implements ActionListener{
    ...
    ContactUs()
    {
        ...
        ImageIcon i20 = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/back.png"));
        ...
        i1 = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/black.jpg"));
        ...
        i4 = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/gmail.png"));
