...
public class Doctor extends JFrame implements ActionListener
{
    ...
    Doctor()
    {
        ...
        TempImage = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/img2.png"));
        ...
        TempImage = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/patientinfo.jpg"));
        ...
        TempImage = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/pastrecords.png"));
        temp = TempImage.getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT);
        ...
        TempImage = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/Report&Medicine.png"));
        temp = TempImage.getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT);
