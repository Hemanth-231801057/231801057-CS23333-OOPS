...
public class Chemist extends JFrame implements ActionListener
{
    ...
    Chemist()
    {
        ...
        TempImage = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/img8.png"));
        ...
        TempImage = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/see_medicineinfo.png"));
        ...
        TempImage = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/Add-medicine.png"));
        temp = TempImage.getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT);
