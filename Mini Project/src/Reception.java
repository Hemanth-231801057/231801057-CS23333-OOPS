...
public class Reception extends JFrame implements ActionListener
{
    ...
    Reception()
    {
        Background1 = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/DarkBackGround.png"));

        JLabel LeftPenal = new JLabel(Background1);
        LeftPenal.setBounds(5, 5, 298, 435);
        add(LeftPenal);

        TempImage = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/Receptionist.png"));
        ...
        TempImage = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/AddUser2.png"));
        ...
        TempImage = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/Appointment11.png"));
        temp = TempImage.getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT);
        ...
        TempImage = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/Mobileupdate4.png"));
        temp = TempImage.getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT);
        ...
        TempImage = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/Picture1.png"));
        temp = TempImage.getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT);
        ...
        TempImage = new ImageIcon(ClassLoader.getSystemResource("H:/mini project/oops/Clinical-Management-System/src/src/cms/appont_list.png"));
